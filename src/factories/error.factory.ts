...
export const errorCodes:ErrorCodes = {
    ...
    not_found: { code: 'NOT_FOUND', defaultInfo: "The element required could not be found." }
}

export type ErrorType = 'unknown' | 'auth' | 'query' | 'not_found';
...
export default function generateError ( type?:ErrorType, info?:any ):ServerError {
